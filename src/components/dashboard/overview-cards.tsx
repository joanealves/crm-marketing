...
export function OverviewCards({ month, year }: OverviewCardsProps) {
  ...
  const vendasMesAtual = vendasFechadas.filter((v) => {
    ...
    return vendaDate.getMonth() === month && vendaDate.getFullYear() === year;
  });
    ...
    <div className="grid gap-4 md:grid-cols-2 lg:grid-cols-4">
      <Card>
        ...
        <CardContent>
          ...
          <p className="text-xs text-muted-foreground">{clientesAtivos} ativos</p>
        </CardContent>
      </Card>
      ...
      <Card>
        ...
        <CardContent>
          ...
          <p className="text-xs text-muted-foreground">{vendasFechadas.length} vendas fechadas</p>
        </CardContent>
      </Card>
      ...
      <Card>
        ...
        <CardContent>
          ...
          <p className="text-xs text-muted-foreground">{vendasMesAtual.length} vendas este mês</p>
        </CardContent>
      </Card>
      ...
      <Card>
        ...
        <CardContent>
          <div className="text-2xl font-bold">{txConversao}%</div>
